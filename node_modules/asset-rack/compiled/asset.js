...
(function() {
  ...
  exports.Asset = (function(_super) {
    ...
    function Asset(options) {
      var headers, key, value, _ref, _ref1, _ref2, _ref3,
        _this = this;
      ...
      this.on('start', function() {
        ...
        if ((_ref4 = _this.maxAge) == null) {
          _this.maxAge = (_ref5 = _this.rack) != null ? _ref5.maxAge : void 0;
        }
        if (_this.hash !== false) {
          if ((_ref6 = _this.maxAge) == null) {
            _this.maxAge = _this.defaultMaxAge;
          }
        }
        if ((_ref7 = _this.allowNoHashCache) == null) {
          _this.allowNoHashCache = (_ref8 = _this.rack) != null ? _ref8.allowNoHashCache : void 0;
        }
